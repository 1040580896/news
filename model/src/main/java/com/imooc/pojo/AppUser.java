...
public class AppUser {
    ...
    public AppUser(String id, String mobile, String nickname, String face, String realname, String email, Integer sex, Date birthday, String province, String city, String district, Integer activeStatus, Integer totalIncome, Date createdTime, Date updatedTime) {
        this.id = id;
        this.mobile = mobile;
        this.nickname = nickname;
        this.face = face;
