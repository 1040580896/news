...
//            cookie.setPath("/");
    ...
    public List<AppUserVO> getBasicUserList(Set idSet) {
        ...
        String userServerUrlExecute
                = "http://SERVICE-USER/user/queryByIds?userIds=" + JsonUtils.objectToJson(idSet);
    ...
    // todo  java.util.LinkedHashMap cannot be cast to com.imooc.pojo.vo.AppUserVO
    // public List<AppUserVO> getBasicUserList(Set idSet) {
    //     // // String userServerUrlExecute
    //     // //         = "http://user.imoocnews.com:8003/user/queryByIds?userIds=" + JsonUtils.objectToJson(idSet);
    //     // String userServerUrlExecute
    ...
    //     List<AppUserVO> userVOList = (List<AppUserVO>) bodyResult.getData();
    //     return userVOList;
    // }
