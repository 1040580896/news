...
public interface MyFansControllerApi {
    ...
    public GraceJSONResult queryRatio(@RequestParam String writerId) throws IOException;

    @ApiOperation(value = "根据地域查询粉丝数量", notes = "根据地域查询粉丝数量", httpMethod = "POST")
    @PostMapping("/queryRatioByRegion")
    public GraceJSONResult queryRatioByRegion(@RequestParam String writerId) throws IOException;
}
